  ...
  return (
    <div className={`bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-xs ${className}`}>
      ...
      <div 
        ...
        onInput={handleInput}
        onBlur={handleInput}
        className={`min-h-[320px] max-h-[600px] w-full max-w-[794px] mx-auto overflow-y-auto p-[53px] text-[13.33px] leading-[20px] text-slate-800 focus:outline-none [&_p]:m-0 [&_p]:mb-[8px] [&_div]:mb-[8px] [&_div:empty]:min-h-[20px] [&_p:empty]:min-h-[20px] [&_h1]:m-0 [&_h1]:mb-[29px] [&_h1]:text-center [&_h1]:text-[16px] [&_h1]:leading-[22px] [&_h1]:font-bold [&_h2]:m-0 [&_h2]:mb-[11px] [&_h2]:text-[14.4px] [&_h2]:leading-[21px] [&_h2]:font-bold ${plainDocumentMode ? '' : ''} empty:before:content-[attr(data-placeholder)] empty:before:text-slate-400 empty:before:pointer-events-none ${contentClassName}`}
