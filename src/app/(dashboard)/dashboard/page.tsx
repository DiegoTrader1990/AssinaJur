...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 font-sans">
      ...
      {showGuide && <section className="rounded-[26px] border border-blue-200 bg-white p-5 shadow-sm sm:p-6"><div className="flex flex-col gap-4 border-b border-slate-100 pb-5 sm:flex-row sm:items-start sm:justify-between"><div className="flex gap-4"><div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#071B3A] text-[#d4af37]"><HelpCircle className="h-5 w-5" /></div><div><p className="text-[10px] font-extrabold uppercase tracking-[.18em] text-blue-600">Primeiro acesso</p><h2 className="mt-1 font-heading text-lg font-extrabold text-[#071B3A]">Bem-vinda ao AssinaJur. Vamos organizar seu atendimento.</h2><p className="mt-1 max-w-2xl text-xs leading-relaxed text-slate-500">Você não precisa aprender tudo agora. O escritório trabalha em três etapas: cliente, documentos e processo. Siga a sequência abaixo sempre que iniciar um novo atendimento.</p></div></div><button type="button" onClick={dismissGuide} className="text-xs font-bold text-slate-500 hover:text-[#071B3A]">Entendi, ocultar guia</button></div><div className="mt-5 grid gap-3 md:grid-cols-3"><Link href="/clientes?novo=true" className="group rounded-2xl border border-slate-200 p-4 transition-all hover:border-blue-300 hover:bg-blue-50/50"><span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-blue-100 text-xs font-extrabold text-blue-700">1</span><p className="mt-3 text-sm font-extrabold text-[#071B3A]">Inicie pelo cliente</p><p className="mt-1 text-xs leading-relaxed text-slate-500">Cadastre ou localize a pessoa. Se houver representante, informe na ficha do cliente.</p><span className="mt-3 block text-xs font-extrabold text-blue-700">Abrir clientes →</span></Link><Link href="/documentos/novo" className="group rounded-2xl border border-slate-200 p-4 transition-all hover:border-blue-300 hover:bg-blue-50/50"><span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-blue-100 text-xs font-extrabold text-blue-700">2</span><p className="mt-3 text-sm font-extrabold text-[#071B3A]">Formalize e envie</p><p className="mt-1 text-xs leading-relaxed text-slate-500">Anexe os PDFs ou escolha um kit. Defina quem assina e envie um único link.</p><span className="mt-3 block text-xs font-extrabold text-blue-700">Enviar documentos →</span></Link><Link href="/processos" className="group rounded-2xl border border-slate-200 p-4 transition-all hover:border-blue-300 hover:bg-blue-50/50"><span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-blue-100 text-xs font-extrabold text-blue-700">3</span><p className="mt-3 text-sm font-extrabold text-[#071B3A]">Conduza o processo</p><p className="mt-1 text-xs leading-relaxed text-slate-500">Depois da assinatura, reúna os documentos no processo para acompanhar o caso.</p><span className="mt-3 block text-xs font-extrabold text-blue-700">Abrir processos →</span></Link></div><div className="mt-4 rounded-xl bg-slate-50 px-4 py-3 text-xs text-slate-600"><strong className="text-[#071B3A]">Atalho:</strong> se o cliente já enviou os PDFs prontos, comece em <Link href="/documentos/novo" className="font-bold text-blue-700 underline">Nova assinatura</Link>. O sistema pede o cliente e orienta os signatários antes de gerar o link.</div></section>}
